...
public class PrivateRecurentEventsPOJO {
    ...
    public PrivateRecurentEventsPOJO(String name, String event_description, String location, Date start_date, Date end_date,
    ...
    public PrivateRecurentEventsPOJO(){}
